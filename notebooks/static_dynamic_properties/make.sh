...
#gfortran -Wall AntidromicStimulationofMNandRC.f90 -o StaticDynamicProperties -O3 ../../MusclePointer.f90 ../../jointAnkleForceTask.f90 ../../AfferentUnit.f90 ../../AfferentPool.f90 ../../SynapticNoise.f90 ../../MuscleSpindle.f90 ../../MuscleHill.f90 ../../Interneuron.f90 ../../InterneuronPool.f90 ../../SynapsePointer.f90 ../../SynapsesFactory.f90 ../../Synapse.f90 ../../CharacterMatrix.f90 ../../PointProcessGenerator.f90 ../../NeuralTractUnit.f90 ../../NeuralTract.f90  ../../queue.f90 ../../CharacterArray.f90 ../../MuscleNoHill.f90 ../../MuscularActivation.f90 ../../MotorUnitPool.f90 ../../AxonDelay.f90 ../../Compartment.f90 ../../MotorUnit.f90   ../../DynamicalArrays.f90 ../../randomSeedInitialize.f90 ../../ogpf.f90 ../../Configuration.f90 ../../PulseConductanceState.f90 ../../ChannelConductance.f90 
gfortran -g -Wall -Wextra -Warray-temporaries -Wconversion -fimplicit-none -fbacktrace -ffree-line-length-0 -fcheck=all -finit-real=nan -std=f2003 -O3 StaticDynamicProperties.f90 -o StaticDynamicProperties -O3 MusclePointer.o jointAnkleForceTask.o AfferentUnit.o AfferentPool.o String.o SynapticNoise.o MuscleSpindle.o MuscleHill.o Interneuron.o InterneuronPoolNoMKL.o SynapsePointer.o SynapsesFactory.o Synapse.o CharacterMatrix.o PointProcessGenerator.o NeuralTractUnit.o NeuralTract.o  queue.o CharacterArray.o MuscleNoHill.o MuscularActivationNoMKL.o MotorUnitPoolNoMKL.o AxonDelay.o Compartment.o MotorUnit.o   DynamicalArrays.o randomSeedInitialize.o ogpf.o Configuration.o PulseConductanceState.o ChannelConductance.o
