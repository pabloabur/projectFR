...
gfortran -c /opt/intel/mkl/include/mkl_spblas.f90
...
gfortran -g -Wall -Wextra -Warray-temporaries -Wconversion -fimplicit-none -fbacktrace -ffree-line-length-0 -fcheck=all -finit-real=nan -std=f2003 -O0 DynamicProperties.f90 -o DynamicProperties -O3 MusclePointer.o jointAnkleForceTask.o AfferentUnit.o AfferentPool.o String.o SynapticNoise.o MuscleSpindle.o MuscleHill.o Interneuron.o InterneuronPool.o SynapsePointer.o SynapsesFactory.o Synapse.o CharacterMatrix.o PointProcessGenerator.o NeuralTractUnit.o NeuralTract.o  queue.o CharacterArray.o MuscleNoHill.o MuscularActivation.o MotorUnitPool.o AxonDelay.o Compartment.o MotorUnit.o   DynamicalArrays.o randomSeedInitialize.o ogpf.o Configuration.o PulseConductanceState.o ChannelConductance.o -Wl,--start-group /opt/intel/mkl/lib/intel64/libmkl_gf_lp64.a /opt/intel/mkl/lib/intel64/libmkl_sequential.a /opt/intel/mkl/lib/intel64/libmkl_core.a -Wl,--end-group -lpthread -lm -ldl -m64 -I /opt/intel/mkl/include
