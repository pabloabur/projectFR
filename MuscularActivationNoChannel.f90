...
module MuscularActivationNoChannelClass
    ...
    public :: MuscularActivationNoChannel

    type MuscularActivationNoChannel
        ...
        type(MotorUnitNoChannel), pointer:: unit(:)
        ...
        contains
            ...
            procedure :: reset
    end type MuscularActivationNoChannel
    
    interface MuscularActivationNoChannel
        module procedure init_MuscularActivation
    end interface MuscularActivationNoChannel

    contains

        type(MuscularActivationNoChannel) function init_MuscularActivation(conf, pool, MUnumber, unit)
            class(Configuration), intent(in), target :: conf        
            character(len = 6), intent(in) :: pool
            integer, intent(in) :: MUnumber
            class(MotorUnitNoChannel), dimension(MUnumber),  intent(in), target:: unit
        ...
        subroutine atualizeActivationSignal(self, t)
            ...
            ! '''
            class(MuscularActivationNoChannel), intent(inout) :: self
            real(wp), intent(in) :: t
...
end module MuscularActivationNoChannelClass
