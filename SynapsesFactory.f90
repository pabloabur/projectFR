...
!            real(wp) :: tau, var, gmax, conn, Pconn, delay, declineFactor
...
!                                                                                position_mm - motorUnitPools(poolOut)%&
!                                                                                unit(unitOut)%position_mm)
!                                                                    weight = declineFactor / (declineFactor + neuronsDistance**2)
!                                                                    gmax = gmax * weight
!                                                                end if
...
!                                                                            unit(unitOut)%&
!                                                                            transmitSpikesThroughSynapses(size(&
!                                                                            tempTransmitSpikes)+1))
!                                                                    
!                                                                    do j = 1, size(tempTransmitSpikes)
...
!                                                                if (declineFactor<1e5) then
!                                                                neuronsDistance = abs(interneuronPools(poolIn)%unit(unitIn)%&
!                                                                    position_mm - motorUnitPools(poolOut)%unit(unitOut)%&
!                                                                    position_mm)
!                                                                    weight = declineFactor / (declineFactor + neuronsDistance**2)
!                                                                    gmax = gmax * weight
!                                                                end if
...
!                                                                    motorUnitPools(poolOut)%unit(unitOut)%&
!                                                                            transmitSpikesThroughSynapses(size(&
!                                                                            tempTransmitSpikes)+1)= SynapsePointer()        
!
!                                                                    call motorUnitPools(poolOut)%unit(unitOut)%&
!                                                                    transmitSpikesThroughSynapses(size(tempTransmitSpikes)+1)%&
!                                                                    assignSynapse(interneuronPools(poolIn)%unit(unitIn)%&
