...
program SynapticDepression
    ...
    character(len = 100) :: folderName = 'synapticdepression/false_decay/trial1/'
    ...
    call conf%changeConfigurationParameter(paramTag, value1, value2)
        ...
        value1 = '0'! it was '7', but this is not useful for current simulation
        value2 = ''
        call conf%changeconfigurationparameter(paramtag, value1, value2)
...
end program SynapticDepression
